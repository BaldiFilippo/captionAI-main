        ...
        <>
            ...
            <div className="">
                <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
                    ...
                    <main className="flex flex-1 w-2/3 flex-col items-center justify-center text-center px-4 mt-4 sm:mb-0 mb-8">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl text-gray-900 dark:text-slate-900 text-center font-bold leading-tight tracking-tighter ">
                            Selezione un immagine da descrivere e ti verrà
                            generata una didascalia
                        </h1>
                                    ...
                                    <div className="flex space-x-2 justify-center">
                                        {originalPhoto && !loading && (
                                            <button
                                                ...
                                                className="rounded-md mt-5 bg-indigo-50 px-3.5 py-2.5 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-100"
                                            >
                                                Upload New Photo
                                            </button>
                                        )}
